 ...
 */
public class PopularRecyclerAdapter extends RecyclerView.Adapter<PopularRecyclerAdapter.SearchRecyclerViewHolder> {

    private final static String TAG = SearchRecyclerViewHolder.class.getSimpleName();
    ...
    public SearchRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_popular, parent, false);


        return new SearchRecyclerViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final SearchRecyclerViewHolder holder, int position) {
