 ...
 */
public class VendorPodcastRecyclerAdapter extends RecyclerView.Adapter<VendorPodcastRecyclerAdapter.ViewHolder> {
    private final static String TAG = VendorRecyclerAdapter.class.getSimpleName();
    ...
    public VendorPodcastRecyclerAdapter(List<Info> infos) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_vendor_podcast, parent, false);
